    ...
    model->setHeaderData(4,Qt::Horizontal,QObject::tr("poste"));
     model->setHeaderData(5,Qt::Horizontal,QObject::tr("salaire"));
      model->setHeaderData(6,Qt::Horizontal,QObject::tr("age"));
       model->setHeaderData(7,Qt::Horizontal,QObject::tr("heure_de_travail"));
        model->setHeaderData(8,Qt::Horizontal,QObject::tr("absences"));
...
bool Employe::checkforchar(QString x)
{
bool check=true;
...
bool Employe::checkforint(QString x)
{
bool check=true;
    for(int i=0;i<x.size();i++)
    {
...
QSqlQueryModel * Employe::triDureeTravail()
{
    QSqlQuery *q = new QSqlQuery();
    QSqlQueryModel *model = new QSqlQueryModel();
...
QSqlQueryModel * Employe::afficher_triesexe()
{
    QSqlQueryModel *model=new QSqlQueryModel();
    model->setQuery("select * from EMPLOYE ORDER BY SEXE");
    model->setHeaderData(0,Qt::Horizontal,QObject::tr("id"));
    model->setHeaderData(1,Qt::Horizontal,QObject::tr("nom"));
     model->setHeaderData(2,Qt::Horizontal,QObject::tr("prenom"));
      model->setHeaderData(3,Qt::Horizontal,QObject::tr("sexe"));
...
QSqlQueryModel * Employe::afficher_triesalaire()
{
    QSqlQueryModel *model=new QSqlQueryModel();
...
QSqlQueryModel * Employe::afficher_trieage()
{
    QSqlQueryModel *model=new QSqlQueryModel();
...
QSqlQueryModel * Employe::recherchef(const QString &id , const QString &nom , const QString &poste)
{

    QSqlQueryModel * model = new QSqlQueryModel();
    model->setQuery("select * from EMPLOYE where ((id LIKE '"+id+"%') OR  (nom LIKE '"+nom+"%')  OR (poste LIKE '"+poste+"%' ))");
    model->setHeaderData(0,Qt::Horizontal,QObject::tr("id"));
    model->setHeaderData(1,Qt::Horizontal,QObject::tr("nom"));
     model->setHeaderData(2,Qt::Horizontal,QObject::tr("prenom"));
      model->setHeaderData(3,Qt::Horizontal,QObject::tr("sexe"));
...
QSqlQueryModel * Employe::recherchef2(const QString &id)
{
